...
def simple_tokenize(text):
    """Simple tokenizer that doesn't require external libraries"""
...
def get_top_keywords(df, text_column='title', n=10):
    ...
    stop_words = {
        ...
        'has', 'he', 'in', 'is', 'it', 'its', 'of', 'on', 'or', 'the', 'to', 
        'was', 'with', 'this', 'that', 'you', 'your', 'we', 'our', 'they',
        'their', 'i', 'me', 'my', 'mine', 'am', 'have', 'had', 'do', 'does', 
